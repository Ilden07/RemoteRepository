...
Попробуем создать конфликт:


* *Конфликт должен вывести определенные строки*

* Моя должность на текущий момент - Специалист по охране труда.

* Но я очень хочу изучить язык программирования.

* Надеюсь я освою необходимые мне знания.


## Семминар №3

* Эта строка добавдена с локального репозитория.
